...
#ifndef CP_DATE_TIME_H
#define CP_DATE_TIME_H
...
#include <ctime>
	...
	{
	public:
		inline virtual time_t	get_time() { return curr_time; }
	...
	public:
		...
		void put(sbuffer&);
		inline virtual void reset() { if (ptpr) ptpr->reset(); }
